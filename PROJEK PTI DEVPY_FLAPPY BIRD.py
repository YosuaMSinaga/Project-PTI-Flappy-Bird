...
music=pygame.mixer.music.load('C:\\Flappy bird\\X2Download.app - Envici November - Original Instrument (128 kbps) (mp3cut.net).wav')
score_sound =pygame.mixer.Sound('C:\\Flappy bird\\flappy (mp3cut.net) (1).wav')
lompat_sound=pygame.mixer.Sound('C:\\Flappy bird\\X2Download.app - Flappy Bird Jumping Sound Effect (128 kbps) (mp3cut.net).wav')
...
back_img = pygame.image.load("C:\\Flappy bird\\background fix.png")
floor_img = pygame.image.load("C:\\Flappy bird\\tanah sengketa.png")
floor_x = 0

# different stages of bird
bird_up = pygame.image.load("C:\\Flappy bird\\B.png")
bird_down = pygame.image.load("C:\\Flappy bird\\B1.png")
bird_mid = pygame.image.load("C:\\Flappy bird\\B2.png")
...
# Memuat gambar pipa
pipe_img = pygame.image.load("C:\\Flappy bird\\Kayu.png")
...
game_over = False
over_img = pygame.image.load("C:\\Flappy bird\\front.png").convert_alpha ()
